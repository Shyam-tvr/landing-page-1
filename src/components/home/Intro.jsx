  ...
  return (
    <section className="relative w-full min-h-screen">
      <Image
        ...
        priority
      />
      <div className="absolute inset-0 flex flex-col items-center px-4 text-center max-w-xl mx-auto space-y-6 md:mt-36 lg:mt-40 xl:mt-56 lg:max-w-3xl lg:space-y-8">
