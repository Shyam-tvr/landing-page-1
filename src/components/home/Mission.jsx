...
const Mission = () => {
  return (
    <section className="w-full flex flex-col xl:flex-row items-center gap-8 mt-12 lg:-mt-96 lg:mb-96 xl:-mt-[700px] xl:mb-[700px] 2xl:-mt-[900px] 2xl:mb-[900px] container mx-auto mb-24 px-4 2xl:px-0">
      {/* Text content */}
