    ...
    <section className='px-12 py-12'>
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            <div className='flex flex-col items-center space-y-4 relative bg-gradient-to-br from-black/0 to-[#FCD201]/15 p-4 rounded-xl'>
                ...
                <Link href=""  className='absolute bottom-8 px-4 py-2 bg-[#FCD901] rounded-lg'>Email us</Link>
            </div>
            <div className='flex flex-col items-center space-y-4 relative bg-gradient-to-br from-black/0 to-[#FCD201]/15 p-4 rounded-xl'>
                ...
                <Link href=""  className='absolute bottom-8 px-4 py-2 bg-[#FCD901] rounded-lg'>Contact us</Link>
            </div>
            <div className='flex flex-col items-center space-y-4 relative bg-gradient-to-br from-black/0 to-[#FCD201]/15 p-4 rounded-xl'>
                <div className='relative w-12 h-12 mt-8'>
                ...
                <h4 className='text-white text-center mb-24 '>Genrobotic Innovations, CDAC Building, Technopark Campus, Thiruvananthapuram Kerala, 695581</h4>
                <Link href="" className='absolute bottom-8 px-4 py-2 bg-[#FCD901] rounded-lg'>View Location</Link>
            </div>
        </div>
    </section>
  )
