...
const news = [
  ...
  {
    heading:
      "City-based startup win national award for revolutionizing urban sanitation ",
    date: "Sep 16,2024",
  ...
  {
    heading:
      "In a first in India, Thiruvananthapuram International Airport to get robotic rover to clean canals",
    date: "Jul 17,2024",
  ...
  {
    heading:
      "Genrobotics launches first industrial park in a private college campus in Kerala",
    date: "May 6,2024",
  ...
  {
    heading:
      "Founders of Kerala startup Genrobotics featured on Forbes 30 under 30 Asia list	",
    date: "May 24,2023",
  ...
  {
    heading:
      "Modi launches Kerala startup Genrobotic's Bandicoot 2.0 to clean sewers	",
    date: "Oct 2,2018",
  ...
  {
    heading:
      "Creative Destruction At Its Best: The Death Of Manual Scavenging?	",
    date: "Mar 5,2018",
...
const Articles = () => {
  ...
  // Detect scroll to hide indicator
  useEffect(() => {
    const handleScroll = () => {
      const scrollEl = scrollRef.current;
      if (!scrollEl) return;

      // Hide indicator when user scrolls down a little
    ...
    <section className="px-4 lg:px-12 py-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8 mt-12">
        ...
        <div className="flex-5 relative">
          ...
          <div className="absolute inset-0 justify-end flex flex-col p-4 aspect-square bg-gradient-to-b from-black/0 to-black/80">
        ...
        <div
          ref={scrollRef}
          className={`flex-7 relative space-y-4 ${
            isMobile && "max-h-96"
          } overflow-y-scroll scrollbar-hide pr-2 mt-4 lg:mt-0`}
          style={{ height: leftHeight }}
        >
          {news.map((item, i) => (
            <div
              key={i}
              className="flex gap-4 flex-col lg:flex-row p-4 bg-[#121212] rounded-xl shrink-0"
            >
          ...
          {/* Scroll Down Indicator inside the scrollable box */}
          {/* {showScrollIndicator && (
