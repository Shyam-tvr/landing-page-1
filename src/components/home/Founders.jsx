    ...
    <section className="px-16 py-4">
      <div className="relative w-full min-h-screen">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 flex flex-col items-center justify-between py-24 bg-gradient-to-b from-0% from-black/40 via-15% via-black/0  to-black/40">
          ...
          <div className="xl:container">
            <div className="flex justify-center divide-x divide-[#FCD901]">
              <div className="text-center px-8">
                <p className="text-[#FCD901] text-3xl font-semibold">Nikhil N P</p>
                <p className="text-white text-base font-light">Co-founder</p>
              </div>
              <div className="text-center px-8">
                <p className="text-[#FCD901] text-3xl font-semibold">Vimal Govind M K</p>
                <p className="text-white text-base font-light">Co-founder & CEO</p>
              </div>
              <div className="text-center px-8">
                <p className="text-[#FCD901] text-3xl font-semibold">Rashid K</p>
                <p className="text-white text-base font-light">Co-founder</p>
              </div>
              <div className="text-center px-8">
                <p className="text-[#FCD901] text-3xl font-semibold">Arun George</p>
                <p className="text-white text-base font-light">Co-founder</p>
              </div>
            </div>
            <p className="mx-20 my-8 text-xl text-white/70">
